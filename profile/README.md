...
`Fort Collins Civic Node: ANTIBODY` is a forming 501(c)(4) with a social welfare mission: We empower individuals to consensually provide categories of data to public data piles, which are free for personal uses within the civil jurisdiction they inhabit but which require licensing agreements to be leveraged by the local government.
...
Additional collaboration with citizen committees is desirable, though the 501(c)(4) shall not be empowered to scale its employee roster based on metrics of size or scale.
